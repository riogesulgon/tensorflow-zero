...
model.compile(loss=tf.keras.losses.mae, optimizer=tf.keras.optimizers.SGD(), # SGD - stochastic gradient descent,
...
# print expanded
print(expanded)
model.fit(expanded, Y, epochs=5) # batch_size=8 is the default. Training the model for 5 epochs
